...
class NewsGateway
{
    ...
    public function create( array $data ): string {
        ...
        $sql = "INSERT INTO news ( image_path, image_url, title, description, location, date )
                VALUES ( :image_path, :image_url, :title, :description, :location, :date )";
        
        $stmt = $this -> conn -> prepare( $sql );

        $stmt -> bindValue( ":image_path", $data[ "image_path" ] ?? null, PDO::PARAM_STR );
